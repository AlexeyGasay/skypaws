    ...
    return {
      slides: [
        ...
        },
        {
          ...
          text: `Не&nbsp;тратьте время на&nbsp;поиск и&nbsp;обучение администраторов
          и&nbsp;менеджеров. Мы&nbsp;полностью берем на&nbsp;себя работу с&nbsp;клиентами: наши специалисты примут звонки, профессионально проконсультируют и&nbsp;продадут услуги. Мы&nbsp;организуем процесс обучения, составим расписание занятий и&nbsp;будем напоминать
